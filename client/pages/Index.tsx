...
export default function Index() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black p-4">
      <div className="bg-black rounded-3xl shadow-2xl border border-slate-600 flex flex-col justify-center items-center -mt-[5px] mb-[6px] pt-[123px] px-20 pb-20 text-center transform scale-150 max-w-4xl w-full">
        {/* Main heading */}
        ...
        <div className="space-y-3">
          {/* Create a Room */}
          <div>
            <h5 className="text-sm font-semibold text-slate-300 hover:text-slate-100 cursor-pointer transition-colors duration-200 py-1 px-3 rounded-lg hover:bg-slate-700 border border-slate-600">
              Create a Room
            </h5>
          </div>
          ...
          <div>
            <h5
              className="text-sm font-semibold text-slate-300 hover:text-slate-100 cursor-pointer transition-colors duration-200 py-1 px-3 rounded-lg hover:bg-slate-700 border border-slate-600"

            ...
            {showJoinInput && (
              <form onSubmit={handleCodeSubmit} className="mt-3 space-y-3">
                <input
                  ...
                  className="w-full px-6 py-2 border border-slate-600 rounded-lg focus:ring-2 focus:ring-slate-400 focus:border-transparent outline-none transition-shadow duration-200 text-center text-slate-200 placeholder-slate-500 bg-slate-800 text-sm font-semibold"
                  autoFocus
                  maxLength={11}
                />
                <button
                  type="submit"
                  className="w-full bg-slate-100 text-slate-900 py-2 px-6 rounded-lg hover:bg-slate-200 transition-colors duration-200 text-sm font-semibold border border-slate-600"
                >
                  Join
                </button>
              </form>
